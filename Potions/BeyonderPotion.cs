...
namespace LordOfTheMysteriesMod.Potions
{
    public static class BeyonderPotion
    {
        ...
        //Return: void
        public static void PotionEffectRoll(Player player, string Pathway, int Sequence, int BeyonderBuff, string[] Abilities)
        {
            ...
            if (player.GetModPlayer<LordOfTheMysteriesModPlayer>().Pathway.Equals("Empty")) {
                if (Sequence < 6) {
                    ...
                    if (!AdvancementResult) {
                        ...
                        BeyonderPotion.AddBeyonderAbilities(player, Abilities);
